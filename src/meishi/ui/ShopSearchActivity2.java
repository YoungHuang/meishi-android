...
public class ShopSearchActivity2 extends Activity implements View.OnClickListener, OnItemClickListener {
	...
	private void search() {
		Task task = new SearchShopListFromNetTask(keywords, 0, MAX_RESULT, new RefreshCallBack() {
			...
			public void refresh(Object... params) {
				List<Shop> shopList = (List<Shop>) params[0];
				shopListAdapter = new ShopListAdapter(ShopSearchActivity2.this, shopList);
				resultsListView.setAdapter(shopListAdapter);
				resultsListView.setVisibility(View.VISIBLE);
				historyListView.setVisibility(View.GONE);
				
				resultsListView.setOnItemClickListener(ShopSearchActivity2.this);
			}
		});
		MainService.newTask(task);
	}
